...
printHeader("Make a Comment About Forensic Expert"); 
foreach($_POST as $key => $value){
	$$key = $value;
}
if($submission == 0) {
echo <<<EOD
<h1 class="title" align="center">Comment on Forensic Expert</h1>
...
$note = <<<EOD
Thank you for your comments on the book "Forensic Expert" at 
...
$x = mail($email, "Comments on Forensic Expert",$note, "From: comments@brainvoyage.com\nReply-To: comments@brainvoyage.com\ncc: comments@brainvoyage.com");
}
