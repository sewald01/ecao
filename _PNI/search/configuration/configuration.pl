...
$INDEXER_START = '/home/content/48/7686848/html/_PNI/'; # re-index

# The base url of your site being indexed
# Be sure it corresponds to the $INDEXER_START directory (end with /)
$BASE_URL = 'http://www.pni.org/';

# The url where ksearch.cgi is located
$SEARCH_URL = "http://www.pni.org/cgi-local/search/ksearch.cgi";

# The full-path of the ksearch directory (end with /)
$KSEARCH_DIR = '/home/content/48/7686848/html/_PNI/search/'; # re-index
...
@VALID_REFERERS = ("http://www.pni.org");

$INDEXER_URL = "http://www.pni.org/cgi-local/search/indexer.cgi";

$PASSWORD = "gomariners";		# required for indexer.cgi
#####################################################################
...
@FILE_EXTENSIONS = ("html", "htm", "shtml", "php"); # re-index
...
$LOG_SEARCH = '/html/searchlogs/search_log.txt';
