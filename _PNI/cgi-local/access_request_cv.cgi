...
$LOG_FILE = $WEB_DIR . ".access_request_cv.log";
...
while(<LOG_FILE>)
{
  if(m/$email/i)
  {
        ...
        print "<META HTTP-EQUIV=\"refresh\" CONTENT=\"5; URL=http://www.pni.org/cv/\">\n";
        ...
        print "<HR>\n";
        print "<A HREF=\"http://www.pni.org/cv/\"><IMG SRC=\"http://www.pni.org/.pictures/arrow_back_t_28x22.gif\" BORDER=0 ALT=\"BACK\"></A>\n";
        print "</BODY>\n";
        print "</HTML>\n";
        close LOG_FILE;
        exit -1;
...
open ACCESS_PASSWORD, "/$WEB_DIR/neppe/.access_password" or die "Error: Can't open neppe.\n";
$p = <ACCESS_PASSWORD>;
chomp $p;
@pass = split /:/, $p;
...
To: $email
Bcc: lv\@pni.org
Subject: Your request for  CV\n\n

Thank you for your interest in the curriculum vitae \(CV\) of Vernon M
Neppe, MD, PhD.
We attach for you the password required to obtain it from the internet.
Please go to http\:\/\/www.pni.org\/cv.
In the second line you should see a link to \"Dr. Neppe\'s CV\".
...
to the CV.
If you want to download the CV from the internet, the following may be useful:
