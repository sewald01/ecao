...
printHeader("Make a Comment About ".$_GET['book']); 
foreach($_POST as $key => $value){
	$$key = $value;
}
if($submission == 0) {

echo '<h1 class="title" align="center">Comment on '.$_GET['book'].'</h1>';
echo <<<EOD
<br><br>
...
$note = "Thank you for your comments on the book \"".$_POST['book']."\" at "; 
$note .= <<<EOD
