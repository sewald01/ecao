...
printHeader("E-Mail a friend about D&eacute;j&agrave; Vu: A Second Look");
...
<p>If you like this site or the book, please alert a friend. Of course, please ensure that your e-mail is legitimate and appropriate (this is monitored and can be traced).</p>
...
I found this fascinating book on D&eacute;j&agrave; Vu, titled D&eacute;j&agrave; Vu: A Second Look by Vernon Neppe MD, PhD at http://www.brainvoyage.com. I thought you might find it of interest and well worth reading!</TEXTAREA></td>
</tr>
<tr>
	<td> &nbsp; </td>
	<td align="left">
...
EOD;
		...
		$picpath = "/home/content/p/s/y/psychewa/html/images/securepic/word.jpg";
		...
		$bgNum = rand(3, 4);
		$image = imagecreatefromjpeg("/home/content/p/s/y/psychewa/html/images/securepic/background$bgNum.jpg");
...
if (md5(strtoupper($_POST['secure_number'])) == $_SESSION['securenum']) { 
	...
	<li><a href=\"http://www.brainvoyage.com/ctbm/emailfriend.php\">E-mail another friend</a></li>
...
EOD;
	...
	$x = mail($email, "$sender wants you to see the book Deja Vu: A Second Look",$message, "From: $senderemail\nReply-To: $senderemail\nbcc: psyche@pni.org");
	if($x)
		echo "success!";
	}
