...
printHeader("E-Mail a friend about D&eacute;j&agrave; Vu: Glossary and Library");
...
I found this fascinating book on D&eacute;j&agrave; Vu, titled D&eacute;j&agrave; Vu: Glossary and Library by Vernon Neppe MD, PhD at http://www.brainvoyage.com. I thought you might find it of interest. Well worth reading!</TEXTAREA></td>
</tr>
<tr>
	<td> &nbsp; </td>
	<td align="left">
...
EOD;
	...
	$x = mail($email, "$sender wants you to see the book Deja Vu: Glossary and Library",$message, "From: $senderemail\nReply-To: $senderemail\nbcc: psyche@pni.org");
	}
