...
printHeader("E-Mail a friend about The Psychology of Deja Vu"); 
...
I found this fascinating book called The Psychology of D&eacute;j&agrave; Vu, by Vernon Neppe MD, PhD at http://www.brainvoyage.com. It is like you are in his office talking to him. I thought you might find it of interest. Well worth reading!</TEXTAREA></td>
</tr>
<tr>
	<td> &nbsp; </td>
	<td align="left">
...
if (md5(strtoupper($_POST['secure_number'])) == $_SESSION['securenum']) { 
	...
	<li><a href=\"http://www.brainvoyage.com/deja/PDV/emailfriend.php\">E-mail another friend</a></li>
...
EOD;
	...
	$x = mail($email, "$sender wants you to see the book The Psychology of Deja Vu",$message, "From: $senderemail\nReply-To: $senderemail\nbcc: psyche@pni.org");
	}
