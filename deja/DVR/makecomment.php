...
printHeader("Make a Comment About D&eacute;j&agrave; Vu: Revisited"); 
foreach($_POST as $key => $value){
	$$key = $value;
}
if($submission == 0) {
echo <<<EOD
<h1 class="title" align="center">Comment on D&eacute;j&agrave; Vu: Revisited</h1>
...
$note = <<<EOD
Thank you for your comments on the book "D&eacute;j&agrave; Vu: Revisited" at 
...
$x = mail($email, "Comments on D&eacute;j&agrave; Vu: Revisited",$note, "From: comments@brainvoyage.com\nReply-To: comments@brainvoyage.com\ncc: comments@brainvoyage.com");
}
