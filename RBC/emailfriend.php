...
printHeader("E-Mail a friend about Reality Begins with Consciousness"); 
...
I found this fascinating book on understand reality, consciousness and the world, Reality Begins with Consciousness: A paradigm shift that works by Dr. Vernon Neppe and Dr. Edward Close at http://www.brainvoyage.com. I thought you might find it of interest. Well worth reading!</TEXTAREA></td>
</tr>
<tr>
	<td> &nbsp; </td>
	<td align="left">
...
if (md5(strtoupper($_POST['secure_number'])) == $_SESSION['securenum']) { 
	...
	<li><a href=\"http://www.brainvoyage.com/RBC/emailfriend.php\">E-mail another friend</a></li>
...
EOD;
	...
	$x = mail($email, "$sender wants you to see the book Reality Begins with Consciousness",$message, "From: $senderemail\nReply-To: $senderemail\nbcc: psyche@pni.org");
